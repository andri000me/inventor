...
function updateDevisi(id = null) {
    ...
    if (id) {
        ...
        $.ajax({
            url: 'devisi/get_id/' + id,
            type: 'post',
            dataType: 'json',
            success: function(response) {
                $("#enama_devisi").val(response.nama_devisi);
                $("#eno_tlp").val(response.no_tlp);
