      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <div class="tile-body">
                   <div class="tile">
            <h3 class="tile-title">Add Pegawai</h3>
           
            <div class="tile-body">
              <form class="form-horizontal" action="<?php echo site_url('pegawai/insert')?>" method="post">
                <div class="form-group row">
                  <label class="control-label col-md-3">npp </label>

                  <div class="col-md-8">
                    <input class="form-control" type="text" name="npp" id="npp" value="<?php echo set_value('npp')?>"  placeholder="Enter npp">
                ...
                <label class="control-label col-md-3">Name</label>
                  <div class="col-md-8">
                    <input class="form-control" type="text" name="nama_pegawai" id="nama_pegawai" value="<?php echo set_value('nama_pegawai')?>" placeholder="Enter full name">
